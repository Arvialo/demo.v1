		...
		<>
			...
			<main>
				<div className="hero-banner">
					<div className="hero-banner-texte">
						<h1 className="slogan">
							...
							Ambition{" "}
							<span className="slogan-gradient">And</span>{" "}
							Adaptation.
						</h1>
				...
				<div className="presentation">
					<h2>AAA Corp</h2>
					<p>
						Nous sommes 3 ingénieurs de l'ESIEA qui avons décidé
						d'accompagner les entreprises voulant booster leurs
						ventes. De la création de sites web au référencement en
						ligne, nous proposons de nombreux services sur-mesure.
						Avec nous, la seule limite est votre imagination.
					</p>
				</div>
				...
				<div className="nos-services-banner">
					...
					<button className="ensavoirplus-button">
						En savoir plus
					</button>
				</div>
			</main>
